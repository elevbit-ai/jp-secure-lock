...
const I18N = {
  pt: {
    ...
    video_1: 'Visão geral — o que é e por que é seguro (em breve)',
    video_2: 'Tutorial — configuração passo a passo (em breve)',
    video_note: 'Roteiros de gravação disponíveis no repositório (docs/VIDEO_SCRIPTS.md).',
    ...
    dl_sub: 'Última build assinada · APK Signature v2 · ~14 MB', cta_dl2: 'Baixar APK',
    dl_rel: 'Releases',
    dl_code: 'adb install -r JP-Secure-Lock-AntiTheft-v1.4.0.apk\n# Verifique antes de instalar:\napksigner verify --print-certs JP-Secure-Lock-AntiTheft-v1.4.0.apk',
  ...
  en: {
    ...
    video_1: 'Overview — what it is and why it is secure (coming soon)',
    video_2: 'Tutorial — step-by-step setup (coming soon)',
    video_note: 'Recording scripts available in the repository (docs/VIDEO_SCRIPTS.md).',
    ...
    dl_sub: 'Latest signed build · APK Signature v2 · ~14 MB', cta_dl2: 'Download APK',
    dl_rel: 'Releases',

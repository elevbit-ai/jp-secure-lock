...
const I18N = {
  pt: {
    ...
    video_2: 'Vídeo em MP4',
    video_note: 'Vídeo em MP4 (3 min, narrado em português) e a versão animada no navegador.',
    video_dl: 'Baixar o MP4',
  ...
  en: {
    ...
    video_2: 'MP4 video',
    video_note: 'MP4 video (3 min, narrated in Portuguese) plus the animated in-browser version.',
    video_dl: 'Download the MP4',
